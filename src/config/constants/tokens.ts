import { ChainId, Token, WBNB, WGLCH } from '@pancakeswap/sdk'
...
const BUSD_TESTNET = new Token(
  ChainId.BSC_TESTNET,
  process.env.NEXT_PUBLIC_GLITCH_DEFAULT_OUTPUT_TOKEN || '0xDf8479ABf17b60DCe07D88B43Fd9f246BEC927F2',
  18,
  'BUSD',
  'Binance USD',
  'https://www.paxos.com/busd/',
...
export const glitchTokens = {
  wglch: WGLCH[ChainId.GLITCH],
  usdt: USDT_TESTNET,
}
