...
import { ETHER, JSBI, TokenAmount, MINIMUM_LIQUIDITY } from '@pancakeswap/sdk'
...
import { ConfirmAddMoreLiquidity } from '../../components/PositionCard'
...
const StyledMetaPool = styled.div`
  margin-top: 32px;
  margin-bottom: 10px;
`;
...
export default function AddLiquidity() {
  ...
  const [currencyIdA, currencyIdB] = router.query.currency || ['GLCH', CAKE[chainId]?.address]
          ...
          {showAddLiquidity && (
            <>
              <AppHeader
                ...
                subtitle={t('Become a Provider to earn up to 0.3% trading fees on all trades made')}
                backTo='/liquidity'
                noConfig
              />
              <CardBody>
                <AutoColumn gap="20px">
                  ...
                  <StyledMetaPool>
                    ...
                    <StyledMetaRow>
                      <span className="label">Transaction Speed</span>
