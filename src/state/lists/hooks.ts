...
import DEFAULT_TOKEN_LIST from '../../config/constants/tokenLists/glitch-default.tokenlist'
import { UNSUPPORTED_LIST_URLS, WARNING_LIST_URLS } from '../../config/constants/lists'
import UNSUPPORTED_TOKEN_LIST from '../../config/constants/tokenLists/glitch-unsupported.tokenlist'
import WARNING_TOKEN_LIST from '../../config/constants/tokenLists/glitch-warning.tokenlist'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.GLITCH]: { ...map1[ChainId.GLITCH], ...map2[ChainId.GLITCH] },
  }
}
