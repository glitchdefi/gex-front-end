...
// console.log(currency);
  ...
  return (
    <Box position="relative" id={id} style={{ border: '2px solid #4F7785', padding: '15px 15px' }}>
      <Flex alignItems="center" justifyContent="space-between">
        <Text id="pair" style={{ color: '#A7C1CA' }}>
          {label}
        </Text>
        {account && (
          <Flex>
            <Text
              ...
              color="textSubtle"
              fontSize="14px"
              style={{ display: 'inline', cursor: 'pointer', color: '#4F7785' }}
            >
        ...
        <Flex>
          ...
          >
            <Flex alignItems="center" justifyContent="space-between" style={{ width: '100%' }}>
              <Flex alignItems="center" justifyContent="space-between" minWidth="160px">
                <Flex>
                  {pair ? (
                  ...
                  {pair ? (
                    ...
                    <Text
                      ...
                      style={{
                        whiteSpace: 'nowrap',
                        fontSize: 20,
                        color: currency?.symbol ? '#E5ECEF' : '#395660',
                        fontWeight: 400,
                      }}
                    >
                ...
                {!disableCurrencySelect && <ChevronDownIcon style={{ fill: '#00FFFF' }} />}
              </Flex>
            </Flex>
          </CurrencySelectButton>

          {/* {token && tokenAddress ? (
            <Flex style={{ gap: '4px' }} ml="17px" alignItems="center">
              <CopyButton
                width="16px"
            ...
            <LabelRow>
              ...
              {account && currency && !disabled && showMaxButton && label !== 'To' && (
                <Button
                  ...
                  scale="xs"
                  variant="secondary"
                  style={{ borderRadius: 0, alignSelf: 'center', color: '#00FFFF', fontSize: 12, border: '1px solid' }}
                >
