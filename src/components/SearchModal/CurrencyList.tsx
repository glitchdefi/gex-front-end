...
const MenuItem = styled(RowBetween)<{ disabled: boolean; selected: boolean;index:any }>`
  background-color: ${({theme,index }) => index%2 === 1?'transparent':theme.colors.backgroundGrey};
  padding: 4px 20px;
  height: 76px;
  display: grid;
...
function CurrencyRow({
  ...
  return (
    ...
    >
      ...
      <Column>
        <Text style={{fontWeight:600,fontSize:16,color:'#E5ECEF'}}>{currency.symbol}</Text>
      ...
      if (index === breakIndex || !data) {
        return (
          <FixedContentRow style={style}>
            <LightGreyCard padding="8px 12px" borderRadius="0px" style={{backgroundColor:'transparent',borderColor:'#00FFFF'}}>
              <RowBetween>
