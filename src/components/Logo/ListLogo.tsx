...
export default function ListLogo({
  ...
  if (!logoURI) return <svg width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_1850_2836)">
