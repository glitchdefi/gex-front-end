    ...
    <Wrapper>
      <Section>
        ...
        <AutoColumn gap="12px" justify="center">
          ...
          <DismissButton onClick={onDismiss} mt="20px">
            {t('Close')}
          </DismissButton>
        </AutoColumn>
      </Section>
  ...
  return (
    <Wrapper>
      <AutoColumn justify="center">
        ...
        <ErrorIcon color="#D32029" width="64px" />
        <Text color="#D32029" style={{ textAlign: 'center', width: '85%',fontSize:24,fontWeight:600, wordBreak: 'break-word' }}>
        Transaction error
                </Text>
      ...
      <Flex justifyContent="center" pt="24px">
        <DismissButton onClick={onDismiss}>{t('Dismiss')
        }</DismissButton>
      </Flex>
    </Wrapper>
  )
